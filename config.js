...
module.exports = {
    ...
    SESSION: process.env.BOT_KING_SESSION === undefined ? '' : process.env.BOT_KING_SESSION,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? '💘𝑩𝑶𝑻-𝑲𝑰𝑵𝑮💘' : process.env.BOT_NAME,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Ameen' : process.env.TAG_HEADER,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    MAHN: process.env.MAAN === undefined ? '917994909899,0' : process.env.MAAN,
    BRANCH: 'master',
    HEROKU: {
